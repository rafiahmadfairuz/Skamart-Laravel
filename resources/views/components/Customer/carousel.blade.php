<div id="banner" class="carousel slide container-md py-3 " data-bs-ride="carousel">
    ...
    <div class="carousel-inner rounded-4 shadow" id="carousel-dalam" data-bs-interval="10000">
      <div class="carousel-item active">
        <img src="{{ url('storage/img/carouselgakatekart.png') }}" class="d-block w-100" alt="..."></img>
      </div>
      <div class="carousel-item" data-bs-interval="2000">
        <img src="{{ url('storage/img/sayuranfitcomcarousel.png') }}" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="{{ url('storage/img/carousel fitcom.png') }}" class="d-block w-100" alt="...">
      </div>
    </div>
